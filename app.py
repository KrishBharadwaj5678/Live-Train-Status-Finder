...
st.write("<h4 style='color:#FF8A08;'>Plan your trip better with our accurate and reliable train status information.</h3>",unsafe_allow_html=True)
st.write("<h6>Get real-time updates on train schedules, delays, and cancellations with Train Tracker. Enter your train number to check its current status and stay informed about your journey.</h3>",unsafe_allow_html=True)
